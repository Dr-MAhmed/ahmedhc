...
const HomeoSection2 = () => {
  return (
    <section className="p-10 bg-white dark:bg-gray-900 text-black dark:text-white">
      <div id="diff" className="p-5 rounded-lg bg-inherit text-center">
        <h3 className="text-lg text-blue-600 dark:text-blue-300 uppercase mb-2">Get To Know</h3>
        <h2 className="text-3xl font-bold text-blue-800 dark:text-blue-400 mb-2">The Difference</h2>
        <h4 className="text-[22px] text-blue-500 dark:text-blue-200 mb-6">All Homeopathic Remedies Are Tested On Human.</h4>

        {/* Adding the image below the text */}
        <div className="flex justify-center mb-8">
          <img src="/beating.png" alt="Beating Heart" className="w-13 h-13" />
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-10 mt-8">
          {['homeopathy', 'allopathy', 'naturopathy', 'acupuncture'].map((type, index) => (
            <div
              key={type}
              className="flex flex-col items-center w-[300px] h-[350px] bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden border border-blue-200 dark:border-blue-700 transition-transform transform hover:scale-105"
            >
              <div className="bg-blue-700 dark:bg-blue-900 w-full py-6">
                <picture>
              ...
              <div className="p-5 text-center">
                <h3 className="text-xl font-bold capitalize text-blue-700 dark:text-blue-300 mb-3">{type}</h3>
        ...
        <ul className="list-disc pl-6 mt-10 text-gray-700 dark:text-gray-300 text-left max-w-6xl mx-auto space-y-4">
